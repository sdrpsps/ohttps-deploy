      ...
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-2xl">
        ...
        <Form {...form}>
          <form className="space-y-6" onSubmit={form.handleSubmit(submit)}>
            <section className="space-y-3"><h3 className="text-sm font-semibold">ohttps</h3>
            ...
            <section className="space-y-3"><h3 className="text-sm font-semibold">Webhook 通知</h3>
            ...
            <section className="grid gap-3 sm:grid-cols-2"><h3 className="col-span-full text-sm font-semibold">调度与保留</h3>
            ...
            <section className="flex items-center justify-between rounded-lg border p-3"><div><p className="text-sm font-medium">共享 SSH 私钥</p><p className="text-xs text-muted-foreground">{settings?.sharedSshPrivateKeyConfigured ? "已配置" : "尚未配置"}</p></div><Button type="button" variant="outline" onClick={onConfigureSshKey}>配置私钥</Button></section>
