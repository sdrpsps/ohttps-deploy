...
export interface Deployer { deploy(target: DeployTarget, material: DeploymentMaterial | DeploymentMaterial[], options?: { dryRun?: boolean; signal?: AbortSignal }): Promise<DeploymentResult>; }
